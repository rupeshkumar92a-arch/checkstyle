...
public class ExpressionOverBlockLambdaCheckTest extends AbstractModuleTestSupport {
    ...
    public void testSingleLineBlockLambdas() throws Exception {
        final String[] expected = {
            ...
            "24:26: " + getCheckMessage(MSG_KEY),
            "34:25: " + getCheckMessage(MSG_KEY),
            "42:42: " + getCheckMessage(MSG_KEY),
            "51:20: " + getCheckMessage(MSG_KEY),
            "59:33: " + getCheckMessage(MSG_KEY),
            "68:23: " + getCheckMessage(MSG_KEY),
            "70:24: " + getCheckMessage(MSG_KEY),
        };
    ...
    @Test
    public void testValidLambdas2() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
                getPath("InputExpressionOverBlockLambdaValid2.java"), expected);
    }

    @Test
    public void testTokensNotNull() {
        final ExpressionOverBlockLambdaCheck check = new ExpressionOverBlockLambdaCheck();
